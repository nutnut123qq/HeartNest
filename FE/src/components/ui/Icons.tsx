// Icon wrapper to handle import issues
...
export const CheckCircleIconSolid: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
...
export const EllipsisVerticalIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
